    ...
    def get(self, request, id):
        try:
            ...
            result = {
                ...
                'funding_amount'       : 0 if int(project.donation_set.aggregate(Sum('funding_option__amount'))['funding_option__amount__sum']) is None else int(project.donation_set.aggregate(Sum('funding_option__amount'))['funding_option__amount__sum']),
